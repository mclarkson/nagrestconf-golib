...
func NewNrcServices(username, password string) *Services {
	h := &Services{}
	h.username = username
	h.password = password
	return h
 ...
 */
func (h *Services) Get(url, endpoint, folder string, data []string) (e error) {
 ...
 */
func (h Services) Post(url, endpoint, folder string, data []string) (e error) {
